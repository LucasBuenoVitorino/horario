...
- **Quarta-feira**: Pensamento Computacional + Relatório
- **Sexta-feira**: Grupo de IA
- Demais horários: Realizar curso da Google

---

## 📌 Sobre o NPI

O NPI é um espaço de aprendizado, prática e desenvolvimento em programação e tecnologia, com foco em projetos, estudos e grupos de interesse.
